...
Estrategia simple: arma un .md editable por temas con las fórmulas clave
tomadas del propio catálogo de modelos implementados. El usuario puede editarlo
libremente después; el RAG lo indexa como cualquier otra fuente.
"""
...
_MACHETE_SEED = """# Machete teórico — Estadística General
